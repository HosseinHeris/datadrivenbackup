...
class env_nn_modeler():
    ...
    def __init__(self,state_space_dim=4,action_space_dim=1):
    ...
    def evaluate_nn_model(self,x_test, y_test,batch_size=32):
        self.score=self.model.evaluate(x_test,y_test, batch_size=32)
        return self.score
...
def create_nn_model_wrapper(activation='relu',state_space_dim=4,action_space_dim=1, dropout_rate=0.1, num_hidden_layers=2, \
...
def create_lstm_model_wrapper(activation='relu',state_space_dim=4,action_space_dim=1, \
