...
def _parse_args():
	...
	parser.add_argument('--model',  default='poly', help='choose type of the simulation envirnment: polym, nn (muli-layer perceptron), lstm, gb (gradient boost). Default is actual sim. ')
